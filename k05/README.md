...
## ソースコードの説明
--深さ優先探索--
l.109 int型の配列visited,val,i,nを定義

l.113 visitedの中身にすべて0を代入

l.117 スタックを初期化

l.118 スタックに出発点をPush

l.121 while文でスタックが空になるまで繰り返す

l.123 valにスタックからポップした値を代入

l.124 visitedのval番目の値が0だったら、1にして、その場所から行ける場所をスタックに入れる

--幅優先探索--

l.199 int型の配列visited,val,i,nを定義

l.203 visitedの中身にすべて0を代入

l.207 キューを初期化

l.208 キューに出発点の値を入れる

l.211 while文でキューが空になるまで繰り返す

l.213 valにキューから取り出した値を代入

l.214 visitedのval番目の値が0だったら、1にして、その場所から行ける場所をキューに入れる
